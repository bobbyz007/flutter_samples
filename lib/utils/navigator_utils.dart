...
import 'package:flutter_samples/utils/route/circle/circle_path.dart';
...
class NavigatorUtils {
  ...
  static pushPage(
    ...
    if (isReplace) {
      //替换当前页面
      return Navigator.of(context).pushReplacement(pageRoute);
    }
    //压栈
  ...
  static openPageByFade(BuildContext context, Widget page,
      {bool isReplace = false,
      bool opaque = true,
      int mills = 800,
      int endMills = 400,
  ...
  static pushPageAboutCircle(BuildContext context, Widget page,
      {Offset? centerOffset, GlobalKey? key, String? routeName, paramtes}) {
            ...
            builder: (context, child) {
              ...
              return ClipPath(
                ...
                clipper: CirclePath(animation.value,
                    centerOffset: centerOffset, key: key ?? GlobalKey()),
                child: child,
              );
            },
